 ...
 * "declarative" paradigm, very little robot logic should actually be handled in the {@link Drive} or {@link Shooter}
...
public class ChargedUpRobot {
  ...
  private void configureBindings() {
    ...
    // Schedule `shootCommand` when the Xbox controller's A button is pressed,
